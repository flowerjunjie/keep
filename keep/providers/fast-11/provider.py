...
class HerokuProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['heroku', 'logs', 'monitoring', 'cloud']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Heroku log monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
