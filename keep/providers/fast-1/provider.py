...
class AWSProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['aws', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "AWS CloudWatch monitoring and metrics (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
