...
class NomadProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Orchestration"
    PROVIDER_TAGS = ['nomad', 'orchestration', 'scheduling', 'hashicorp']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "HashiCorp Nomad (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
