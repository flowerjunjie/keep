...
class KubernetesProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Metrics"
    PROVIDER_TAGS = ['kubernetes', 'containers', 'monitoring', 'orchestration']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Kubernetes metrics (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
