...
class DynatraceProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "APM"
    PROVIDER_TAGS = ['dynatrace', 'apm', 'tracing', 'performance']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Dynatrace APM (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
