...
class PingdomProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['uptime', 'monitoring', 'website', 'availability']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Website uptime monitoring and performance tracking (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
