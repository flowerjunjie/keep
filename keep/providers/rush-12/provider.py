...
class XMattersProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['xmatters', 'incident', 'notification', 'workflow']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "xMatters workflow (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
