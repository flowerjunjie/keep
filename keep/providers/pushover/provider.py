...
class PushoverProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ["alert", "mobile", "notification", "simple", "push"]
    PROVIDER_DESCRIPTION = "Pushover provider for sending simple, reliable push notifications to mobile devices."
