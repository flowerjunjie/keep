...
class BambooProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['bamboo', 'ci', 'cd', 'build', 'atlassian']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Bamboo (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
