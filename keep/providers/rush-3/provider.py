...
class BitbucketProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Git"
    PROVIDER_TAGS = ['atlassian', 'git', 'code', 'repository']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Bitbucket (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
