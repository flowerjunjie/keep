...
class CloudFlareProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Analytics"
    PROVIDER_TAGS = ['cloudflare', 'cdn', 'analytics', 'monitoring']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "CloudFlare analytics (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
