...
class TeamCityProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "CI"
    PROVIDER_TAGS = ['teamcity', 'ci', 'cd', 'build', 'jetbrains']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "JetBrains TeamCity (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
