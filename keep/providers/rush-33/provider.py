...
class AnsibleProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['ansible', 'automation', 'config', 'management', 'devops']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Ansible automation (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
