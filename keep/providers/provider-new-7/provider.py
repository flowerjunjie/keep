...
class OpenNMSProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "OpenNMS"
    PROVIDER_TAGS = ['network', 'monitoring', 'management', 'open-source']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Open-source network management platform (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
