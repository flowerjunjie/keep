...
class F5Provider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "BIGIP"
    PROVIDER_TAGS = ['f5', 'load-balancer', 'monitoring', 'network']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "F5 BIG-IP monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
