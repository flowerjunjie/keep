...
This provider receives SNMP traps and events from newrelic monitoring and converts them to Keep alerts.
"""
...
class NewRelicProvider(BaseProvider):
    """Receive SNMP traps and events from newrelic monitoring."""

    PROVIDER_DISPLAY_NAME = "NewRelic"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from newrelic monitoring."
