...
class JiraProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Software"
    PROVIDER_TAGS = ['atlassian', 'issue', 'tracking', 'project']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Jira integration (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
