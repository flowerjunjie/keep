...
class GitHubProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Actions"
    PROVIDER_TAGS = ['github', 'actions', 'ci', 'cd', 'workflow']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "GitHub Actions (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
