...
class FireHydrantProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Incident"
    PROVIDER_TAGS = ['firehydrant', 'incident', 'response', 'reliability']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "FireHydrant incident (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
