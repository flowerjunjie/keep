...
class BetterUptimeProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['uptime', 'monitoring', 'incident', 'status-page']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Modern uptime monitoring with status pages (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
