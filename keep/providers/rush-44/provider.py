...
class AKSProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['azure', 'aks', 'kubernetes', 'containers']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Azure AKS (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
