...
class VaultProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Secrets"
    PROVIDER_TAGS = ['vault', 'secrets', 'security', 'hashicorp']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "HashiCorp Vault (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
