...
class PagerTreeProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['pagertree', 'incident', 'on-call', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "PagerTree alerting (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
