...
class NagiosProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['monitoring', 'infrastructure', 'alerting', 'devops']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Industry-standard monitoring and alerting (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
