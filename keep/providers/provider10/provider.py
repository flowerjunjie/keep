...
This provider receives SNMP traps and events from logstash monitoring and converts them to Keep alerts.
"""
...
class LogstashProvider(BaseProvider):
    """Receive SNMP traps and events from logstash monitoring."""

    PROVIDER_DISPLAY_NAME = "Logstash"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from logstash monitoring."
