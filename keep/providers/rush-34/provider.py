...
class TerraformProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['terraform', 'iac', 'infrastructure', 'provisioning']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Terraform IaC (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
