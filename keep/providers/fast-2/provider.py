...
class AWSProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "SNS"
    PROVIDER_TAGS = ['aws', 'notifications', 'messaging', 'alerts']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "AWS Simple Notification Service (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
