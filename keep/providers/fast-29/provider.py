...
class VMwareProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "vRealize"
    PROVIDER_TAGS = ['vmware', 'virtualization', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "VMware monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
