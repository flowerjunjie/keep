...
This provider receives SNMP traps and events from sentry monitoring and converts them to Keep alerts.
"""
...
class SentryProvider(BaseProvider):
    """Receive SNMP traps and events from sentry monitoring."""

    PROVIDER_DISPLAY_NAME = "Sentry"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from sentry monitoring."
