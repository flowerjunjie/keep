...
This provider receives SNMP traps and events from elasticsearch monitoring and converts them to Keep alerts.
"""
...
class ElasticsearchProvider(BaseProvider):
    """Receive SNMP traps and events from elasticsearch monitoring."""

    PROVIDER_DISPLAY_NAME = "Elasticsearch"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from elasticsearch monitoring."
