...
class AlibabaProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['alibaba', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Alibaba Cloud monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
