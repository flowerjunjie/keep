...
class VictorOpsProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Alerting"
    PROVIDER_TAGS = ['victorops', 'incident', 'on-call', 'response']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "VictorOps incident response (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
