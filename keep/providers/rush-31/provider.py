...
class NexusProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['nexus', 'repository', 'artifacts', 'maven']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Nexus repository (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
