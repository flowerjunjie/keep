...
class LinodeProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Longview"
    PROVIDER_TAGS = ['linode', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Linode monitoring service (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
