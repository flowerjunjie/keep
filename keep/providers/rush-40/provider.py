...
class DockerProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['docker', 'containers', 'images', 'registry']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Docker containers (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
