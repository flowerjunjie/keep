...
class TravisCIProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['travisci', 'ci', 'cd', 'build', 'testing']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Travis CI (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
