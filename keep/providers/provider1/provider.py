...
This provider receives SNMP traps and events from datadog monitoring and converts them to Keep alerts.
"""
...
class DatadogProvider(BaseProvider):
    """Receive SNMP traps and events from datadog monitoring."""

    PROVIDER_DISPLAY_NAME = "Datadog"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from datadog monitoring."
