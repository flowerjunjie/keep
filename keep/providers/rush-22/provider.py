...
class JenkinsProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['jenkins', 'ci', 'cd', 'build', 'pipeline']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Jenkins CI/CD (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
