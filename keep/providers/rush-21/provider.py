...
class RundeckProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Automation"
    PROVIDER_TAGS = ['rundeck', 'automation', 'job', 'scheduling']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Rundeck job scheduler (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
