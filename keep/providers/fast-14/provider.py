...
class VultrProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['vultr', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Vultr cloud monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
