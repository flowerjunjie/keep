...
class GitLabProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['gitlab', 'ci', 'cd', 'repository', 'devops']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "GitLab CI/CD (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
