...
class ElasticsearchProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['search', 'analytics', 'logs', 'monitoring']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Distributed search and analytics engine (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
