...
class BigPandaProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "AIOps"
    PROVIDER_TAGS = ['bigpanda', 'aiops', 'incident', 'correlation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "BigPanda AIOps (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
