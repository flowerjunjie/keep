...
class PulumiProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['pulumi', 'iac', 'infrastructure', 'code']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Pulumi IaC (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
