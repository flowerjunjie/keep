...
This provider receives SNMP traps and events from dynatrace monitoring and converts them to Keep alerts.
"""
...
class DynatraceProvider(BaseProvider):
    """Receive SNMP traps and events from dynatrace monitoring."""

    PROVIDER_DISPLAY_NAME = "Dynatrace"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from dynatrace monitoring."
