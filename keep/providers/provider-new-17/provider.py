...
class JaegerProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['tracing', 'distributed', 'monitoring', 'microservices']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Distributed tracing platform for microservices (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
