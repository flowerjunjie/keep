...
class GKEProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['gcp', 'gke', 'kubernetes', 'containers']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Google GKE (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
