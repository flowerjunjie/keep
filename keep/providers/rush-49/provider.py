...
class IstioProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Service"
    PROVIDER_TAGS = ['istio', 'service', 'mesh', 'kubernetes']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Istio service mesh (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
