...
class KubernetesProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['kubernetes', 'containers', 'orchestration', 'k8s']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Kubernetes orchestration (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
