...
class DigitalOceanProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['digitalocean', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "DigitalOcean monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
