...
class OP5Provider(BaseProvider):
    ...
    PROVIDER_TAGS = ['monitoring', 'network', 'infrastructure', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Network infrastructure monitoring and alerting (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
