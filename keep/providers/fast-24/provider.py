...
class ImpervaProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Monitoring"
    PROVIDER_TAGS = ['imperva', 'security', 'monitoring', 'waf']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Imperva security monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
