...
class SonarQubeProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Quality"
    PROVIDER_TAGS = ['sonarqube', 'code', 'quality', 'security', 'analysis']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SonarQube analysis (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
