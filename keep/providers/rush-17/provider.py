...
class SquadcastProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Reliability"
    PROVIDER_TAGS = ['squadcast', 'on-call', 'reliability', 'incident']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Squadcast reliability (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
