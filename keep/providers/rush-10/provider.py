...
class PagerDutyProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Enterprise"
    PROVIDER_TAGS = ['pagerduty', 'incident', 'escalation', 'enterprise']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "PagerDuty Enterprise (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
