...
class CiscoProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['cisco', 'apm', 'monitoring', 'application']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Cisco application monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
