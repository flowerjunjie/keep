...
class IncidentIOProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Management"
    PROVIDER_TAGS = ['incidentio', 'incident', 'response', 'coordination']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Incident.io management (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
