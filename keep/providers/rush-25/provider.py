...
class CircleCIProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['circleci', 'ci', 'cd', 'build', 'testing']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "CircleCI CI/CD (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
