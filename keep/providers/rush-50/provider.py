...
class LinkerdProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Service"
    PROVIDER_TAGS = ['linkerd', 'service', 'mesh', 'microservices']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Linkerd service mesh (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
