...
class AppDynamicsProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['apm', 'monitoring', 'application', 'performance']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Application performance monitoring and analytics (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
