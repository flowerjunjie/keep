...
class OpsgenieProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['atlassian', 'incident', 'on-call', 'escalation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Opsgenie (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
