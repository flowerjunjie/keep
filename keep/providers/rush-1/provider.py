...
class ServiceNowProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "ITSM"
    PROVIDER_TAGS = ['itsm', 'incident', 'service', 'management']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "ServiceNow IT Service Management (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
