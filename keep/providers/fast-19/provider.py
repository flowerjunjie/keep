...
class SoftLayerProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Monitoring"
    PROVIDER_TAGS = ['softlayer', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SoftLayer monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
