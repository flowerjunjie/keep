...
class RancherProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Kubernetes"
    PROVIDER_TAGS = ['rancher', 'kubernetes', 'management', 'multi-cluster']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Rancher K8s (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
