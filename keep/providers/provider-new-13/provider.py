...
class GrafanaProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['visualization', 'metrics', 'dashboards', 'analytics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Open analytics and interactive visualization (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
