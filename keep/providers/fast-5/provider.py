...
class AzureProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Monitor"
    PROVIDER_TAGS = ['azure', 'monitoring', 'metrics', 'cloud']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Azure Monitor service (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
