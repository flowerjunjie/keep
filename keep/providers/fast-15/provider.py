...
class HetznerProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['hetzner', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Hetzner cloud monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
