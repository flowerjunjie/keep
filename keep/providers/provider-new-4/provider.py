...
class StatusCakeProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['uptime', 'monitoring', 'website', 'performance']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Website and server monitoring platform (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
