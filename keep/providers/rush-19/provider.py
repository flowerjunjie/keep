...
class MoogsoftProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['moogsoft', 'aiops', 'incident', 'correlation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Moogsoft AIOps (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
