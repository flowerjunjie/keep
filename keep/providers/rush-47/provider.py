...
class ConsulProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Service"
    PROVIDER_TAGS = ['consul', 'service', 'discovery', 'mesh']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "HashiCorp Consul (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
