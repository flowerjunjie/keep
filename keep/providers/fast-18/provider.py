...
class RackspaceProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['rackspace', 'cloud', 'monitoring', 'managed']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Rackspace monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
