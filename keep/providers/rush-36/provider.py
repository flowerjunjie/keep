...
class ChefProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Config"
    PROVIDER_TAGS = ['chef', 'config', 'management', 'automation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Chef configuration (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
