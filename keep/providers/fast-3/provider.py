...
class AWSProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "SES"
    PROVIDER_TAGS = ['aws', 'email', 'notifications', 'sending']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "AWS Simple Email Service (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
