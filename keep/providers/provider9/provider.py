...
This provider receives SNMP traps and events from kibana monitoring and converts them to Keep alerts.
"""
...
class KibanaProvider(BaseProvider):
    """Receive SNMP traps and events from kibana monitoring."""

    PROVIDER_DISPLAY_NAME = "Kibana"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from kibana monitoring."
