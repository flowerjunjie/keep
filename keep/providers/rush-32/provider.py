...
class ArtifactoryProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Repository"
    PROVIDER_TAGS = ['artifactory', 'repository', 'artifacts', 'jfrog']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "JFrog Artifactory (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
