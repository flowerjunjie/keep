...
class UpCloudProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Monitoring"
    PROVIDER_TAGS = ['upcloud', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "UpCloud monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
