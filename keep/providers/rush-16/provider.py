...
class StatuspageProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Communication"
    PROVIDER_TAGS = ['statuspage', 'status', 'communication', 'public']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Statuspage (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
