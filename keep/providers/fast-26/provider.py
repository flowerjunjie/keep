...
class CitrixProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "ADC"
    PROVIDER_TAGS = ['citrix', 'adc', 'monitoring', 'network']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Citrix ADC monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
