...
class HarborProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Registry"
    PROVIDER_TAGS = ['harbor', 'docker', 'registry', 'security']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Harbor registry (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
