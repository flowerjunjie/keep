...
class PrometheusProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['metrics', 'monitoring', 'time-series', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Open-source metrics and alerting toolkit (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
