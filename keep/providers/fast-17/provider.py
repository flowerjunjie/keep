...
class OVHProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['ovh', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "OVH monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
