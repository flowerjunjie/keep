...
class SplunkProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['splunk', 'siem', 'security', 'analytics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Splunk SIEM (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
