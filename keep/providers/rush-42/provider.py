...
class EKSProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['aws', 'eks', 'kubernetes', 'containers']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "AWS EKS (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
