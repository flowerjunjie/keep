...
class InfluxDBProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['database', 'time-series', 'metrics', 'monitoring']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Time-series database for monitoring and IoT (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
