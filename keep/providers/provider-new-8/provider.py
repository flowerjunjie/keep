...
class ObserviumProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['network', 'monitoring', 'infrastructure', 'discovery']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Network discovery and monitoring platform (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
