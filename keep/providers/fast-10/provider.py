...
class FirebaseProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['firebase', 'mobile', 'monitoring', 'analytics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Firebase performance monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
