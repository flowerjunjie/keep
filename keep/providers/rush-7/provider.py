...
class NewRelicProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Infrastructure"
    PROVIDER_TAGS = ['newrelic', 'infrastructure', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "NewRelic infrastructure (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
