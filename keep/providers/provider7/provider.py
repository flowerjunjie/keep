...
This provider receives SNMP traps and events from grafana monitoring and converts them to Keep alerts.
"""
...
class GrafanaProvider(BaseProvider):
    """Receive SNMP traps and events from grafana monitoring."""

    PROVIDER_DISPLAY_NAME = "Grafana"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from grafana monitoring."
