...
class ConfluenceProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Docs"
    PROVIDER_TAGS = ['atlassian', 'wiki', 'documentation', 'collaboration']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Atlassian Confluence (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
