...
This provider receives SNMP traps and events from prometheus monitoring and converts them to Keep alerts.
"""
...
class PrometheusProvider(BaseProvider):
    """Receive SNMP traps and events from prometheus monitoring."""

    PROVIDER_DISPLAY_NAME = "Prometheus"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from prometheus monitoring."
