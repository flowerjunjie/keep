...
class ZabbixProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['monitoring', 'infrastructure', 'metrics', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Enterprise-class monitoring solution (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
