...
class OpenShiftProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "Containers"
    PROVIDER_TAGS = ['openshift', 'kubernetes', 'containers', 'redhat']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Red Hat OpenShift (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
