...
class AkamaiProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['akamai', 'cdn', 'monitoring', 'security']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Akamai monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
