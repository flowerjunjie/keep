...
class UptimeRobotProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['uptime', 'monitoring', 'website', 'alerts']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Website monitoring with incident response (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
