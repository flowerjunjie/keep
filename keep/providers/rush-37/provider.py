...
class PuppetProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['puppet', 'config', 'management', 'automation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Puppet automation (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
