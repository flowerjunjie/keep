...
This provider receives SNMP traps and events from splunk monitoring and converts them to Keep alerts.
"""
...
class SplunkProvider(BaseProvider):
    """Receive SNMP traps and events from splunk monitoring."""

    PROVIDER_DISPLAY_NAME = "Splunk"
    PROVIDER_TAGS = ["alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SNMP (Simple Network Management Protocol) provider for receiving SNMP traps and events from splunk monitoring."
