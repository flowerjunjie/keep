...
class LibreNMSProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['network', 'monitoring', 'auto-discovery', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Auto-discovering network monitoring system (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
