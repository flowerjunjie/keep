...
class SaltStackProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Config"
    PROVIDER_TAGS = ['saltstack', 'config', 'management', 'automation']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "SaltStack automation (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
