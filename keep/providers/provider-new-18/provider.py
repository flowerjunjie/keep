...
class ZipkinProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['tracing', 'distributed', 'monitoring', 'latency']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Distributed tracing system for latency analysis (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
