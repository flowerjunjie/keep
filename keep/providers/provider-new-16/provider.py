...
class GraphiteProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['monitoring', 'metrics', 'visualization', 'time-series']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Enterprise time-series monitoring platform (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
