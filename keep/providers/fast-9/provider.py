...
class TencentProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "CloudMonitor"
    PROVIDER_TAGS = ['tencent', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Tencent Cloud monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
