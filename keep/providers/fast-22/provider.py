...
class FastlyProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['fastly', 'cdn', 'analytics', 'monitoring']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Fastly monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
