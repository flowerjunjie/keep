...
class TelegrafProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['metrics', 'collection', 'monitoring', 'agent']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Plugin-driven server agent for metrics (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
