...
class StackStormProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Automation"
    PROVIDER_TAGS = ['stackstorm', 'automation', 'workflow', 'orchestration']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "StackStorm automation (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
