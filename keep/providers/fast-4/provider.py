...
class GoogleProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['gcp', 'monitoring', 'metrics', 'cloud']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Google Cloud Platform monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
