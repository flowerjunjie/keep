...
class JuniperProvider(BaseProvider):
    """Receive SNMP traps and events from network devices."""

    PROVIDER_DISPLAY_NAME = "Contrail"
    PROVIDER_TAGS = ['juniper', 'networking', 'monitoring', 'sdn']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Juniper networking (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
