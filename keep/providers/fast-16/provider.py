...
class ScalewayProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['scaleway', 'cloud', 'monitoring', 'metrics']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Scaleway monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
