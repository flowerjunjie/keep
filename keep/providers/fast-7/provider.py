...
class OracleProvider(BaseProvider):
    ...
    PROVIDER_DISPLAY_NAME = "CloudMonitoring"
    PROVIDER_TAGS = ['oracle', 'cloud', 'monitoring', 'infrastructure']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Oracle Cloud Infrastructure monitoring (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
