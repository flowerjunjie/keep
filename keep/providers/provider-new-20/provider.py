...
class LokiProvider(BaseProvider):
    ...
    PROVIDER_TAGS = ['logging', 'monitoring', 'aggregation', 'alerting']"alert", "network", "snmp", "traps", "infrastructure"]
    PROVIDER_DESCRIPTION = "Horizontally-scalable log aggregation system (Simple Network Management Protocol) provider for receiving SNMP traps and events from network devices."
